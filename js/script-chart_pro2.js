...
function pieChart() {
  ...
  function init() {
    ...
    $('#chartData2 td').each( function() {
      ...
      if ( currentCell % 2 != 0 ) {
        ...
        chartData[currentRow]['label'] = $(this).text() + "años";
      } else {
  ...
  function handleChartClick ( clickEvent ) {
    ...
    var mouseX = clickEvent.pageX - parseInt( $("#chart2").offset().left );
    //var mouseY = clickEvent.pageY - this.offsetTop;
    var mouseY = clickEvent.pageY - parseInt( $("#chart2").offset().top  );

    //console.log("          mymouseX: " + (clickEvent.pageX - parseInt($("#chart2").offset().left)) + "          mouseX: " + mouseX + "          pageX: " + clickEvent.pageX + "          offsetLeft: " + this.offsetLeft + "\n" );
    //console.log("          mymouseY: " + (clickEvent.pageY - parseInt($("#chart2").offset().top )) + "          mouseY: " + mouseY + "          pageY: " + clickEvent.pageY + "          offsetTop: " + this.offsetTop + "\n" );
