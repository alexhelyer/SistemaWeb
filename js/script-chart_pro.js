...
function pieChart() {
  ...
  function handleChartClick ( clickEvent ) {
    ...
    var mouseX = clickEvent.pageX - parseInt( $("#chart").offset().left );
    //var mouseY = clickEvent.pageY - this.offsetTop;
    var mouseY = clickEvent.pageY - parseInt( $("#chart").offset().top  );

    //console.log("          mymouseX: " + (clickEvent.pageX - parseInt($("#chart").offset().left)) + "          mouseX: " + mouseX + "          pageX: " + clickEvent.pageX + "          offsetLeft: " + this.offsetLeft + "\n" );
    //console.log("          mymouseY: " + (clickEvent.pageY - parseInt($("#chart").offset().top )) + "          mouseY: " + mouseY + "          pageY: " + clickEvent.pageY + "          offsetTop: " + this.offsetTop + "\n" );
